...
export const AgentTestRun: core.serialization.ObjectSchema<serializers.AgentTestRun.Raw, Speechify.AgentTestRun> =
    core.serialization.object({
        ...
        result: TestRunResult.optionalNullable(),
...
export declare namespace AgentTestRun {
    export interface Raw {
        ...
        result?: (TestRunResult.Raw | null) | null;
        error?: string | null;
        created_at: string;
    }
}
