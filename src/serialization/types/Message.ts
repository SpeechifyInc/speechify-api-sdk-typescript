...
export const Message: core.serialization.ObjectSchema<serializers.Message.Raw, Speechify.Message> =
    core.serialization.object({
        ...
        toolResult: core.serialization.property("tool_result", core.serialization.unknown().optional()),
