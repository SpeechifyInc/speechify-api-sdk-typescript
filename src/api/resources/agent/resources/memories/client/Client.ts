...
export class Memories {
     ...
     * @param {Speechify.agent.DeleteMemoriesRequest} request
    ...
    public async delete(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `v1/agents/memories/${encodeURIComponent(memoryId)}`,
            ),
            method: "DELETE",
            headers: {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SpeechifyTimeoutError(
                    "Timeout exceeded when calling DELETE /v1/agents/memories/{memoryId}.",
                );
            case "unknown":
                throw new errors.SpeechifyError({
