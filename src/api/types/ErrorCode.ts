...
export const ErrorCode = {
    ...
    ConversationNotReachable: "conversation_not_reachable",
    ConversationChannelBound: "conversation_channel_bound",
    ConversationPromptNotFound: "conversation_prompt_not_found",
